...
#' linear (l) dependence on extinction – alternative formulation
#'
...
#' to be fed as argument `dd_model` to [comrad::fit_dd_model_with_fossil()].  This formulation corresponds to the exponential model
#' found in `DDD` (`ddmodel = 2`)
#'
